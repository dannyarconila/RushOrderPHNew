-- Preserve the exact Pasugo booking target on customer notifications.

ALTER TABLE public.notifications
  ADD COLUMN IF NOT EXISTS pasugo_booking_id uuid;

COMMENT ON COLUMN public.notifications.pasugo_booking_id
  IS 'Exact Pasugo booking associated with this customer notification.';


-- Customer starts Pasugo rider-selection flow.
...
BEGIN
  ...
  VALUES (
    b.customer_id,
    'Choose a rider',
    'Select an available rider for your Pasugo booking.',
    'dispatch',
    b.id
  );
