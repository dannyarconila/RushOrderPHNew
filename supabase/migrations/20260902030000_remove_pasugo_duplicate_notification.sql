-- Remove duplicate manual Pasugo rider notification.
--
-- pasugo_dispatch_offers INSERT already fires the canonical
-- trg_notify_rider_new_pasugo_dispatch trigger.
-- That trigger stores the exact dispatch_offer_id used by
-- send-push for rider navigation.
--
-- Keep the trigger as the single notification source.
