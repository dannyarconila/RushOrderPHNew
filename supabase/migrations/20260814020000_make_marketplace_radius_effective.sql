-- ============================================================
-- Make marketplace_customer_radius_km effective at the
-- database query layer.
--
-- Customer marketplace radius controls store discovery.
-- It does NOT affect store delivery_radius_km or rider
-- dispatch radius.
-- ============================================================
...
REVOKE ALL
ON FUNCTION public.get_marketplace_stores(numeric, numeric, text)
FROM public;
